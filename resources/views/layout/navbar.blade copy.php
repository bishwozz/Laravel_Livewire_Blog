<header class="header header--loggedIn">
    <div class="container">
        <a wire:click.prevent="home" class="header__logo">
        ...
        @endauth
            ...
            <div class="dropdown-menu">
                <a href="" class="dropdown-link"><svg version="1.1"
                    ...
                    Settings</a>
                <a  wire:click.prevent="logout" class="dropdown-link"><svg version="1.1" xmlns="http://www.w3.org/2000/svg"
