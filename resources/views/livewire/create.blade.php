      ...
      <div class="layout__body">
        <form class="form">
          ...
          <div class="form__group">
            ...
            <input type="file" wire:model="image" id="image" class="@error('image') is-invalid @enderror">
          ...
          <div class="form__action">
            ...
            <button class="btn btn--main" type="submit" wire:click.prevent="storePost()">Submit</button>
          </div>
        </form>
      </div>
    </div>
